...
class Optimization(CensoPart):
    ...
    def run(self) -> None:
        ...
        if self._instructions["macrocycles"] and len(self.ensemble.conformers) > 1:
            """
