...
def test_prescreening_gas_phase(
    mock_execute, mock_factory, mock_ensemble, mock_config, mock_execute_results
):
...
@patch("censo.ensembleopt.prescreening.Factory")
@patch("censo.ensembleopt.prescreening.execute")
def test_prescreening_empty_ensemble(mock_execute, mock_factory, mock_config):
...
@patch("censo.ensembleopt.prescreening.Factory")
@patch("censo.ensembleopt.prescreening.execute")
def test_prescreening_single_conformer(mock_execute, mock_factory, mock_config):
